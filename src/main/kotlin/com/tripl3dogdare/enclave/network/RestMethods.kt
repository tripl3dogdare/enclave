...
fun Rest.modifyChannel(cid: Snowflake, data:JsonNode?) =
...
fun Rest.createMessage(cid: Snowflake, data:JsonNode?) =
...
fun Rest.editMessage(cid: Snowflake, mid: Snowflake, data:JsonNode?) =
...
fun Rest.bulkDeleteMessages(cid: Snowflake, data:JsonNode?) =
  send(POST, "/channels/%s/messages/bulk-delete", cid, data=data)
fun Rest.editChannelPermissions(cid: Snowflake, oid: Snowflake, data:JsonNode?) =
...
fun Rest.createChannelInvite(cid: Snowflake, data:JsonNode?) =
...
fun Rest.groupDmAddRecipient(cid: Snowflake, uid: Snowflake, data:JsonNode?) =
...
fun Rest.createGuildEmoji(gid: Snowflake, data:JsonNode?) =
  send(POST, "/guilds/%s/emojis", gid, data=data)
fun Rest.modifyGuildEmoji(gid: Snowflake, eid: Snowflake, data:JsonNode?) =
...
fun Rest.modifyGuild(gid: Snowflake, data:JsonNode?) =
  send(PATCH, "/guilds/%s", gid, data=data)
fun Rest.deleteGuild(gid: Snowflake, data:JsonNode?) =
  send(DELETE, "/guilds/%s", gid, data=data)
fun Rest.getGuildChannels(gid: Snowflake) =
  send(GET, "/guilds/%s/channels", gid)
fun Rest.createGuildChannel(gid: Snowflake, data:JsonNode?) =
  send(POST, "/guilds/%s/channels", gid, data=data)
fun Rest.modifyGuildChannelPositions(gid: Snowflake, data:JsonNode?) =
...
fun Rest.addGuildMember(gid: Snowflake, uid: Snowflake, data:JsonNode?) =
  send(PUT, "/guilds/%s/members/%s", gid, uid, data=data)
fun Rest.modifyGuildMember(gid: Snowflake, uid: Snowflake, data:JsonNode?) =
  send(PATCH, "/guilds/%s/members/%s", gid, uid, data=data)
fun Rest.modifyCurrentUserNick(gid: Snowflake, data:JsonNode?) =
...
fun Rest.createGuildRole(gid: Snowflake, data:JsonNode?) =
  send(POST, "/guilds/%s/roles", gid, data=data)
fun Rest.modifyGuildRolePositions(gid: Snowflake, data:JsonNode?) =
  send(PATCH, "/guilds/%s/roles", gid, data=data)
fun Rest.modifyGuildRole(gid: Snowflake, rid: Snowflake, data:JsonNode?) =
...
fun Rest.createGuildIntegration(gid: Snowflake, data:JsonNode?) =
  send(POST, "/guilds/%s/integrations", gid, data=data)
fun Rest.modifyGuildIntegration(gid: Snowflake, iid: Snowflake, data:JsonNode?) =
...
fun Rest.modifyGuildEmbed(gid: Snowflake, data:JsonNode?) =
...
fun Rest.createWebhook(cid: Snowflake, data:JsonNode?) =
...
fun Rest.modifyWebhook(wid: Snowflake, data:JsonNode?) =
  send(PATCH, "/webhooks/%s", wid, data=data)
fun Rest.modifyWebhookWithToken(wid: Snowflake, wtk: Snowflake, data:JsonNode?) =
...
fun Rest.executeWebhook(wid: Snowflake, wtk: Snowflake, data:JsonNode?) =
  send(POST, "/webhooks/%s/%s", wid, wtk, data=data)
fun Rest.executeSlackCompatibleWebhook(wid: Snowflake, wtk: Snowflake, data:JsonNode?) =
  send(POST, "/webhooks/%s/%s/slack", wid, wtk, data=data)
fun Rest.executeGitHubCompatibleWebhook(wid: Snowflake, wtk: Snowflake, data:JsonNode?) =
